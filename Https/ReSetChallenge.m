...
+(AFHTTPSessionManager *)SingleTrackHTTPS {
...
+ (AFHTTPSessionManager *)SubtendTrackHttps;
{
...
+(BOOL)extractIdentity:(SecIdentityRef*)outIdentity andTrust:(SecTrustRef *)outTrust fromPKCS12Data:(NSData *)inPKCS12Data {
    ...
    NSDictionary*optionsDictionary = [NSDictionary dictionaryWithObject:@"p12的密码"
